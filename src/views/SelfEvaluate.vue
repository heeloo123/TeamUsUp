    ...
    <div class="background">
      <div class="header">
        ...
        <p>
          ...
          {{ project.projectID }} {{ project.projectName }} | Self Evaluation
        </p>
      </div>

      <div>
        <p>
          <label style="font-size:20px">Please noted :</label> Everything that you put into this form will
          be kept strictly confidential by the unit coordinator.
        </p>
      </div>
      ...
      <div class="container">
        <div class="detail">
          ...
          <div
            ...
            "
          >
            <label>{{ $state.user.firstName }} {{ $state.user.lastName }}</label>
